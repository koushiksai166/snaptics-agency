...
! function(t, e) {
    ...
    function zb(e, r, i) {
        ...
        if (!p) {
            ...
            else if ("./index.html" === e.charAt(0)) {
                if (e.length < 6 && (e = "./index.html" + (n = e.charAt(1)) + n + (a = e.charAt(2)) + a + (s = e.charAt(3)) + s + (5 === e.length ? e.charAt(4) + e.charAt(4) : "")), 9 === e.length) return [(p = parseInt(e.substr(1, 6), 16)) >> 16, p >> 8 & At, p & At, parseInt(e.substr(7), 16) / 255];
